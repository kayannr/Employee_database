...
-- (join 2 tables: employees and salaries)
...
FROM employees
FULL JOIN dept_employees ON dept_employees.emp_no=employees.emp_no
FULL JOIN departments ON departments.dept_no=dept_employees.dept_no
